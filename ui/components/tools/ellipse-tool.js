/**
 * ellipse-tool.js - Ellipse creation tool using Paper.js
 * Fresh implementation - click+drag to create ellipses
 */
...
(function() {
    ...
    const tool = {
        onMouseDown(e, svgCanvas) {
            ...
            state.drawingPath = new paper.Path.Ellipse({
                point: [pos.x, pos.y],
                size: [1, 1],
                strokeColor: '#00d4aa',
                fillColor: null,
        ...
        onMouseUp(e, svgCanvas) {
            ...
            const pp = new paper.Path.Ellipse({
                point: [x, y],
                size: [w, h]
            });
    ...
    window.VectorEditor.tools.ellipse = tool;
