/**
 * bool-xor.js  —  /ui/components/modifiers
 * Boolean XOR / EXCLUDE  (A △ B) — area in A or B but not both.
 * Uses Paper.js p1.exclude(p2).
 */
(function () {
    function _import (d) {
        if (!d) return null;
    ...
    function apply (basePathData, params, s) {
        ...
        let r = null;
        try { r = p1.exclude(p2); } catch (e) { console.warn('[bool-xor]', e); }
    ...
    window.VectorEditor.Modifiers['bool-xor'] = { apply };
})();
